    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            for (var i = 0; i < data.length; i++) {
                result1 = result1 + '<span class="myLikedEmail">' + data[i].likedByName + '</span>' + '</br>'
            }
            document.getElementById(myData).getElementsByClassName("myLikedNames")[0].style.display = "block";
            document.getElementById(myData).getElementsByClassName("myLikedNames")[0].innerHTML = result1;
        },
...
function GetCommentList(myData) {
    ...
    $.ajax({
        ...
        success: function (data) {
            var result2 = '';
            for (var i = 0; i < data.length; i++) {
                result2 = result2 + '<div class="commentDetails"><div class="commentImgDiv"><img class="commentImg" src="' + 'http://127.0.0.1:8080/' + data[i].commentedByImagepath + '"/></div><div class="commentData"><div><a class="commentName" href="/Profile/ProfileData/' + data[i].commentedBy + '">' + data[i].commentedByName + '</a></br><span class="commentText"> ' + data[i].commentedText + '</span ></div></div></div>'
            }
            document.getElementById(myData).getElementsByClassName("myCommentsList")[0].innerHTML = result2
            //GetCommentsCount();
        },
        error: function (xhr, status, error) {
            alert("An error occurred: " + error);
...
$(document).ready(function () {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            document.getElementsByClassName("aboutSectionRightFriendsListDiv")[0].innerHTML = result3;
        },
        error: function (xhr, status, error) {
            alert("An error occurred: " + error);
        }
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            document.getElementsByClassName("postOptionLeftFriendsListDiv")[0].innerHTML = result4;
        },
        error: function (xhr, status, error) {
            alert("An error occurred: " + error);
        }
    ...
    $.ajax({
        ...
        success: function (data) {
            for (var i = 0; i < data.length; i++) {
                result5 = result5 + '<div class="ImgDiv"><img class="myPhotos" src="http://127.0.0.1:8080/' + data[i].imagepath.split('Uploads\\')[1] + '"/></div>';
            }
            document.getElementsByClassName("aboutSectionRightPhotosListDiv")[0].innerHTML = result5;
        },
        error: function (xhr, status, error) {
            alert("An error occurred: " + error);
        }
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            for (var i = 0; i < len; i++) {
                result6 = result6 + '<div class="ImgDiv"><img class="myPhotosPost" src="http://127.0.0.1:8080/' + data[i].imagepath.split('Uploads\\')[1] + '"/></div>';
            }
            document.getElementsByClassName("postOptionLeftPhotosListDiv")[0].innerHTML = result6;
        },
        error: function (xhr, status, error) {
            alert("An error occurred: " + error);
        }
