...
$(document).ready(function () {
    ...
    $(".myProfilelogoImgRight").click(function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (imgElem && data.profileImagePath) imgElem.src = data.profileImagePath
            },
            error: function (xhr, status, error) {
                alert("An error occurred: " + error);
            }
                    ...
                    (function (notiData) {
                        ...
                        $.ajax({
                            ...
                            success: function (data1) {
                                ...
                                var imgSrc = (profile && profile.profileImagePath) ? profile.profileImagePath : "/images/default-profile.png";
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if (nameElem) nameElem.textContent = data.firstName + " " + data.surname;
            if (imgElem && data.profileImagePath) imgElem.src = data.profileImagePath;
            if (rightImgElem && data.profileImagePath) rightImgElem.src = data.profileImagePath
        },
        error: function (xhr, status, error) {
            alert("An error occurred: " + error);
        }
