...
function DisplayLikes(myData) {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            document.getElementById(myData).getElementsByClassName("likedNames")[0].style.display = "block";
            document.getElementById(myData).getElementsByClassName("likedNames")[0].innerHTML = result
        },
...
function DisplayLikesHide(myData) {
    document.getElementById(myData).getElementsByClassName("likedNames")[0].style.display = "none";
}
...
function ShowComments(myData) {
    if (document.getElementById(myData).getElementsByClassName("commentSection")[0].style.display == "block") {
        document.getElementById(myData).getElementsByClassName("commentSection")[0].style.display = "none";
    }
    else {
        document.getElementById(myData).getElementsByClassName("commentSection")[0].style.display = "block";
    }

    document.getElementById(myData).getElementsByClassName("commentSection")[0].getElementsByClassName("addComment")[0].focus();
}
                ...
                $.ajax({
                    ...
                    success: function (data1) {
                        if (data1.status == "Online") {
                            result = result + '<div class="contactDiv"><div class="contactImg"><img class="contactImg" src="' + 'http://127.0.0.1:8080/' + data1.profileImagePath.substr(64) + '"/><div class="onlineMarkerBG"><div class="onlineMarker"></div></div></div><a class="contactData" href="/Profile/ProfileData?email=' + data1.email + '">' + data1.firstName + " " + data1.surname + '</a></div>'
                        }
                        else {
                            result = result + '<div class="contactDiv"><div class="contactImg"><img class="contactImg" src="' + 'http://127.0.0.1:8080/' + data1.profileImagePath.substr(64) + '"/></div><a class="contactData" href="/Profile/ProfileData?email=' + data1.email + '">' + data1.firstName + " " + data1.surname + '</a></div>'
                        }
                    },
                    error: function (xhr, status, error) {
                        showError(error);
